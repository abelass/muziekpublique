...
$spip_asso_activites = array(
	...
	"non_membres_prevente" 	=> "text NOT NULL",	
	"prix_ext_1_valeur" 	=> "text NOT NULL",
	"prix_ext_1_titre" 	=> "text NOT NULL",
	"prix_ext_2_valeur" 	=> "text NOT NULL",
	"prix_ext_2_titre" 	=> "text NOT NULL",
	"prix_ext_3_valeur" 	=> "text NOT NULL",
	"prix_ext_3_titre" 	=> "text NOT NULL",		
