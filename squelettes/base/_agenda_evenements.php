...
$evenements = array(
		...
		"maj"	=> "TIMESTAMP",
		"prix_non_membres"	=> "bigint(21) DEFAULT '0' NOT NULL",		
		"prix_membres"	=> "bigint(21) DEFAULT '0' NOT NULL",
		"prix_prevente_membres"	=> "bigint(21) DEFAULT '0' NOT NULL",
		"prix_prevente_non_membres"	=> "bigint(21) DEFAULT '0' NOT NULL",
		);
