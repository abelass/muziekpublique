 ...
 */
function formulaires_inscription2_charger_dist($id_auteur = NULL,$redirect = null,$option= NULL){
	...
	$champs['option']=$option;
	if($option=='provisoire')$champs['_hidden']='<input type="hidden" name="statut_provisoire" value="oui"/>';
	
	return $champs;
}

function formulaires_inscription2_verifier_dist($id_auteur = null,$redirect = null,$option= NULL){
...
function formulaires_inscription2_traiter_dist($id_auteur = NULL,$redirect = null,$option= NULL){
