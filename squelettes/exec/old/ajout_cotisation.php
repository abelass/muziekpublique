	...
	**/
	...
	function exec_ajout_cotisation(){
		...
		while($data = spip_fetch_array($query)) {
			...
			echo '<label for="date_paiement"><strong>'._T('asso:Date du paiement (AAAA-MM-JJ)').' :</strong></label>';
			echo '<input name="date_paiement" type="text" value="'.date('Y-m-d').'" id="date_paiement" class="formo" />';
