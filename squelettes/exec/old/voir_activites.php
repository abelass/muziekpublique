<?php
	...
	**/
	...
	//TABLEAU
		...
		echo '<th><strong>'._T('date_paiement').'</strong></th>';
		...
		while ($data = spip_fetch_array($query)) {
			...
			echo '<td style="border-top: 1px solid #CCCCCC;text-align:right;" class ='.$class.'>'.$data['date_paiement'].'</td>';
			echo '<td style="border-top: 1px solid #CCCCCC;text-align:right;" class ='.$class.'>'.$data['statut'].'</td>';
