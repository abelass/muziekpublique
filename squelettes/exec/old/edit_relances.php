<?php
	...
	**/
	...
	function exec_edit_relances(){
		...
		echo '<form method="post" action="'.$url_edit_relances.'">';
		...
		$query = spip_query ( "SELECT * FROM spip_auteurs_elargis a LEFT JOIN spip_auteurs b ON a.id_auteur=b.id_auteur WHERE email <> ''  AND statut_interne like '$statut' AND statut_interne <> 'sorti' ORDER by nom_famille" );
