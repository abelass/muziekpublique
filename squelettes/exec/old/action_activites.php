	...
	**/
	...
	function exec_action_activites(){
		...
		if ($action=="ajoute"){
			...
			spip_query( "INSERT INTO spip_asso_activites (date, id_evenement, nom, id_adherent, membres, non_membres, inscrits, email, telephone, adresse, montant, source_paiement, commentaire,type_paiement,validite) VALUES ("._q($date).", "._q($id_evenement).", "._q($nom).", "._q($id_membre).", "._q($membres).", "._q($non_membres).", "._q($inscrits).", "._q($email).", "._q($telephone).", "._q($adresse).", "._q($montant).","._q($source_paiement).",  "._q($commentaire).",  "._q($type_paiement).",  "._q($validite)." )" );
