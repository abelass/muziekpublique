...
function exec_edit_activite_args($id_activite, $id_evenement)
{
	...
	if ($data){
			...
			$prevente_non_membre=$data['prevente_non_membre'];			
			$prix_ext_1_valeur=$data['prix_ext_1_valeur'];			
			$prix_ext_1_titre=$data['prix_ext_1_titre'];			
			$prix_ext_2_valeur=$data['prix_ext_2_valeur'];				
			$prix_ext_2_titre=$data['prix_ext_2_titre'];			
			$prix_ext_3_valeur=$data['prix_ext_3_valeur'];			
			$prix_ext_3_titre=$data['prix_ext_3_titre'];							
	...
	if (!$data) {
		...
		$lieu=$data['lieu'];			
		$prevente=$data['prix_prevente_non_membres'];	
		$prix_ext_1_titre=$data['prix_ext_1_titre'];			;						
		$prix_ext_2_titre=$data['prix_ext_2_titre'];					
		$prix_ext_3_titre=$data['prix_ext_3_titre'];	
		...
		// prix extras suivant le concert
		
		if($prevente)$extra .='<label for="prevente_non_membre"><strong>'._T('asso:prix_prevente_non_membres')." :</strong></label>\n"
		.'<input name="non_membres"  type="text" size="40" value="'.$prevente_non_membre.'" id="prevente_non_membre" class="formo" />';
				
		if($prix_ext_1_titre)$extra .='<label for="prix_ext_1_valeur"><strong>'.$prix_ext_1_titre." :</strong></label>\n"
		.'<input name="prix_ext_1_valeur"  type="text" size="40" value="'.$prix_ext_1_valeur.'" id="prix_ext_1_valeur" class="formo" />';
				
		if($prix_ext_2_titre)$extra .='<label for="prix_ext_2_valeur"><strong>'.$prix_ext_2_titre." :</strong></label>\n"
		.'<input name="prix_ext_2_valeur"  type="text" size="40" value="'.$prix_ext_2_valeur.'" id="prix_ext_2_valeur" class="formo" />';
				
		if($prix_ext_3_titre)$extra .='<label for="prix_ext_3_valeur"><strong>'.$prix_ext_3_titre." :</strong></label>\n"
		.'<input name="prix_ext_3_valeur"  type="text" size="40" value="'.$prix_ext_3_valeur.'" id="prix_ext_3_valeur" class="formo" />';	
